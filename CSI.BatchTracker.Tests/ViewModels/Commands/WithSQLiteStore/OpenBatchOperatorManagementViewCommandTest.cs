...
{
    [TestFixture]
    class OpenBatchOperatorManagementViewCommandTest : OpenBatchOperatorManagementViewCommandBehaviorTest
    {
        ...
        public override void SetUp()
        {
            ...
            command = new OpenBatchOperatorManagementViewCommand(viewModel);
            base.SetUp();
        }
