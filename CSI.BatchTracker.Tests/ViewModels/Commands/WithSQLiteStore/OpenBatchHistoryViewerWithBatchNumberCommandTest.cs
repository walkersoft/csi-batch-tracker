...
{
    [TestFixture]
    class OpenBatchHistoryViewerWithBatchNumberCommandTest : OpenBatchHistoryViewerWithBatchNumberCommandBehaviorTest
    {
        ...
        public override void SetUp()
        {
            ...
            command = new OpenBatchHistoryViewerWithBatchNumberCommand(viewModel);
            base.SetUp();
        }
